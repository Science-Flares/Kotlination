...
Applying Kotlin plugins with `apply` in the Kotlin Gradle DSL is not recommended – [see why](https://kotlinlang.org/docs/gradle.html#using-the-gradle-kotlin-dsl).
